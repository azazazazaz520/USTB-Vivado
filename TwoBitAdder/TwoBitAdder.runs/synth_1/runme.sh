...
HD_PWD='D:/source/Vivado/USTB-Vivado/TwoBitAdder/TwoBitAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TwoBitAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TwoBitAdder.tcl
