...
HD_PWD='D:/source/Vivado/USTB-Vivado/TwoBitAdder/TwoBitAdder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TwoBitAdder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TwoBitAdder.tcl -notrace
