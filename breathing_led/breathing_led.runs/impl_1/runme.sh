...
HD_PWD='D:/source/Vivado/USTB-Vivado/breathing_led/breathing_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log breathing_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source breathing_led.tcl -notrace
