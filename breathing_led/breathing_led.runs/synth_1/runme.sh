...
HD_PWD='D:/source/Vivado/USTB-Vivado/breathing_led/breathing_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log breathing_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source breathing_led.tcl
