...
HD_PWD='D:/source/Vivado/USTB-Vivado/alarm/alarm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alarm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alarm.tcl -notrace
