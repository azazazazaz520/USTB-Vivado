...
HD_PWD='D:/source/Vivado/USTB-Vivado/alarm/alarm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alarm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alarm.tcl
