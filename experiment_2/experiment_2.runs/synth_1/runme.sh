...
HD_PWD='D:/source/Vivado/USTB-Vivado/experiment_2/experiment_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log segMsg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source segMsg.tcl
