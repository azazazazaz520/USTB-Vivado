...
HD_PWD='D:/source/Vivado/USTB-Vivado/experiment_2/experiment_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log segMsg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source segMsg.tcl -notrace
