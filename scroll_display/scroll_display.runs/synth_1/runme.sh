...
HD_PWD='D:/source/Vivado/USTB-Vivado/scroll_display/scroll_display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scroll_display_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scroll_display_top.tcl
