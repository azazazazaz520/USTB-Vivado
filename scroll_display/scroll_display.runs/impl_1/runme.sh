...
HD_PWD='D:/source/Vivado/USTB-Vivado/scroll_display/scroll_display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scroll_display_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source scroll_display_top.tcl -notrace
