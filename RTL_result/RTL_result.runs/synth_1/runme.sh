...
HD_PWD='D:/source/Vivado/USTB-Vivado/RTL_result/RTL_result.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log example1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source example1.tcl
